...
<!-- This is the upstream package guide. The age-scale branch keeps its project
overview in README.md, so knitting this file would replace that branch-specific
page. -->
...
We can see that the individual with higher bilirunbin levels (id=231) has a higher and increasing 5-year risk of transplant. This can be explained by the dynamic hazard rate of bilirunbin (seen above). 
